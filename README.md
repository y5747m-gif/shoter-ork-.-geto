...
![الخرائط](previews/08-الخرائط-الخمس.png)
...
|---|---|---|
| `W A S D` | الحركة | عصا التحكم على اليسار |
...
public/
  ...
  js/render.js  محرك الرسم: أرض، مبانٍ، شخصيات، رصاص، مؤثرات جزيئية، عاصفة، ميني ماب
...
tests/          اختبارات شاملة (٢٥ + ٥٣ + ٢١ حالة)
...
npm run test:client    # ٥٣ اختبار عميل: DOM حقيقي (jsdom) + تشغيل ١٤٠٠ إطار رسم على ٥ خرائط
...
npm run previews       # توليد صور PNG للعبة في مجلد previews/
```

حالة الاختبارات الحالية: **٢٥/٢٥** منطق · **٥٣/٥٣** عميل · **٢١/٢١** أونلاين — بلا أي خطأ.

## 📸 صور من اللعبة
في مجلد `previews/`: معارك على الخرائط الخمس، الهبوط بالمظلة، الشخصيات باسكناتها، وأشكال الخرائط.

## 🛠️ ملاحظات تقنية
- **صفر اعتماديات على الإنترنت وقت اللعب**: الرسم بالـ Canvas 2D، والصوت مُركّب بـ WebAudio (لا ملفات).
